...
export const paymentsSizeNameArray = (windowWidth) => {
    let sizeArray = [
        ...
        { id: 4, size: 150, name: "Приймав", fullName: "Пзізвіще відповідального за отримання проплати" },
    ];
    if (windowWidth > 800) {
        sizeArray = [
            ...
            { id: 3, size: 250, name: "Назва (прізвіще та ініціали)", fullName: "Офіційна назва(призвіще) клієнта" },
